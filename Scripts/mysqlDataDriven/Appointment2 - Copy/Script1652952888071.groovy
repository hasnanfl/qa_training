...
WebUI.click(findTestObject('Object Repository/RealTestCaseDemo/Page_CURA Healthcare Service/input_Medicaid_programs'))
...
WebUI.click(findTestObject('Object Repository/RealTestCaseDemo/Page_CURA Healthcare Service/td_24'))
