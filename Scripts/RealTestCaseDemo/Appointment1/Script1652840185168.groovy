...
WebUI.selectOptionByValue(findTestObject('TestLoginDemo/Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center        _5b4107'), 
    'Seoul CURA Healthcare Center', false)

WebUI.click(findTestObject('Object Repository/RealTestCaseDemo/Page_CURA Healthcare Service/label_Apply for hospital readmission'))

WebUI.click(findTestObject('Object Repository/RealTestCaseDemo/Page_CURA Healthcare Service/span_Visit Date (Required)_glyphicon glyphi_cada34'))
